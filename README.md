...
- Understand core embedded concepts  
- Interface hardware with microcontrollers  
- Write basic embedded C / ESP-IDF code  
...
2. Open respective module folder  
3. Read `.md` file  
4. Run code on hardware  
...
- IoT enthusiasts  
- Developers moving into hardware  
